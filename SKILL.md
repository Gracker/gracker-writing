...
平台结构跟对应 skill（如 `x-tweet-writer`）。文风、AI 味、升格和收尾跟本 skill。社交正文里不出现内部过程、路径、skill 名、质检报告。定时任务投到 Telegram 的可发布稿，必须是用户能全选、一键贴到社交平台的完整正文：信息、判断和链接写进句子里；不要 `账本` 这类黑话；不要 status、评分、落盘路径、「今日精选」或把 Obsidian 工作稿整份发出去。
...
- 社交稿再按 `references/social-output-gate.md` 扫一遍：changelog 综述、否定开场、`一、二、三` 功能并列、口号收尾、名人硬挂钩
