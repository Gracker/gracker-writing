...
完整规则见 `references/style-rules.md` 和 `references/copy-editing.md`。写作、改写、质检前必须按需读取，尤其是：禁用词库、否定-纠正结构、假想读者错误、冗余确认副词、翻译腔动词、结构性元叙述、抽象名词主语、硬换行、中英文空格、机器可读内容边界、术语大小写和中文错词规则。
